  ...
  return (
    <section className=" w-full bg-primary p-5 md:p-20">
      <div className="relative flex justify-between">
        <Image
          className="object-fit md:max-w-[600px]"
          data-aos="fade-right"
          data-aos-offset="300"
        ...
        <Image
          className="object-fit h-20 w-auto absolute md:right-[28rem] top-[200px]"
          data-aos="fade-left"
          data-aos-offset="500"
      ...
      <div
        className="relative flex justify-end flex-end"
        data-aos="fade-left"
        data-aos-offset="500"
        data-aos-duration="500"
        data-aos-easing="ease-in-sine">
        ...
        <Image
          className="object-fit h-20 w-auto absolute md:right-[40rem] top-[200px]"
          data-aos="fade-right"
          data-aos-offset="300"
          data-aos-easing="ease-in-sine"
          src={Receive}
